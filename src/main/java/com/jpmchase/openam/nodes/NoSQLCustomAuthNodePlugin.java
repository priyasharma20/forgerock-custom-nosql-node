 ...
 * @since AM 5.5.0
 */
public class NoSQLCustomAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(NoSQLCustomAuthNodePlugin.currentVersion, 
				Collections.singletonList(NoSQLCustomAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return NoSQLCustomAuthNodePlugin.currentVersion;
	}
}
